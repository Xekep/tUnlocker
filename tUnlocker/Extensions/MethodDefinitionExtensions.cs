...
namespace tUnlocker.Extensions
{
    using Mono.Cecil;
    ...
    public static class MethodDefinitionExtensions
    {
        ...
        /// <summary>
        /// Removes the given range of instructions.
        /// </summary>
        /// <param name="md"></param>
        /// <param name="startOffset"></param>
        /// <param name="size"></param>
        /// <param name="instructions"></param>
        public static void RemoveRange(this MethodDefinition md, int startOffset, int size, params Instruction[] instructions)
        {
            for (var x = startOffset; x < (startOffset + size); x++)
                md.Body.Instructions.RemoveAt(startOffset);
            md.OptimizeBranches();
        }

        /// <summary>
        /// Replaces the given range of instructions with nops.
        /// </summary>
        /// <param name="md"></param>
        /// <param name="startOffset"></param>
        /// <param name="size"></param>
        /// <param name="instructions"></param>
        public static void ReplaceNops(this MethodDefinition md, int startOffset, int size, params Instruction[] instructions)
        {
            for (var x = startOffset; x < (startOffset + size); x++)
            {
                md.Body.Instructions[x].OpCode = OpCodes.Nop;
                md.Body.Instructions[x].Operand = null;
            }
            md.OptimizeBranches();
        }
